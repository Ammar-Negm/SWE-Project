...
<div id="wrapper">
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column mt-3">
      <a class="nav-link active" href="#"><i class="bi bi-grid-1x2"></i> My Shift</a>
      <a class="nav-link" href="#"><i class="bi bi-list-check"></i> Batch Pick List</a>
      <a class="nav-link" href="#"><i class="bi bi-box-seam"></i> Packing Station</a>
      <a class="nav-link" href="#"><i class="bi bi-shield-check"></i> QC Inspection</a>
    </nav>
